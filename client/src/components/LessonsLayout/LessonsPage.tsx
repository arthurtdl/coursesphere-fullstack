      ...
      <div className="flex h-[60vh] flex-col items-center justify-center gap-6 text-center">
        <div className="space-y-2">
          ...
          <p className="text-slate-500">
            O conteúdo que você busca pode ter sido removido.
          </p>
        </div>
        <Button
            ...
            <section className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-500 shadow-sm">
                  ...
                  <span>
                    {format(new Date(course.start_date), "dd 'de' MMM", {
                      locale: ptBR,
                    })}{" "}
                    —{" "}
                    {format(new Date(course.end_date), "dd 'de' MMM", {
                      locale: ptBR,
                    })}
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-6">
                ...
                {isOwner && (
                  <Button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-100 transition-all active:scale-95"
                  >
